...
<html>
<head>
<title>Silent Hunter MODs - PMC Tactical</title>
<LINK href="css.css" rel=stylesheet type="text/css">
<META name="description" content="Silent Hunter MODs - PMC Tactical">
...
<h1><b>PMC Tactical Silent Hunter MODs</b></h1>
...
<p>You can find few selected mods overviews for <a href="silent-hunter-4-mods.php">SH4</a> and <a href="silent-hunter-5-mods.php">SH5</a>, more mod listings will be added once we decipher through the terrible forum topics in subsim.com forums, it is that difficult to find proper info on a mods over there.
</p>

<p>
BTW: We most likely will not add Silent Hunter 3 mod overviews because even though we do have it installed, its 4:3 aspect ratio and so outdated by now that there is just no point of playing it, other than to give it a quick try for nostalgy reasons. Also finding those mods might be troublesome. If you want U-Boot action, play SH5.
</p>

<p>Usually its best to use simple mega mod or just very few mods of your own choice. If you try to combine larger set of mods, then you run into the problem of getting file overwritting warnings as two mods modify the same file. It is better not to go down that road as it surely will give config problems for the game.
</p>
